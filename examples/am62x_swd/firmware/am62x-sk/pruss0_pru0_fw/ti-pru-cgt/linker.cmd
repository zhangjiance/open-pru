...
MEMORY
{
	 ...
	 * source/include/PROCESSOR/pru_intc.h */
...
SECTIONS {
	...
	/* Ensure resource_table section is aligned on 8-byte address for
	   ARMv8 (64-bit) kernel. Place at fixed high address to avoid
	   conflict with other data sections that remoteproc loads. */
	.resource_table : ALIGN (8) >  0x1F00, PAGE 1
